...
face_cascade = cv2.CascadeClassifier("age_model\haarcascade_frontalface_default.xml")

interpreter_age = tf.lite.Interpreter(model_path="age_model\AgeClass_best_06_02-16-02.tflite")
